...
<?php
    ...
    extract($_POST);
    $cliente = !empty($client) ? $client : "<a href=\"ingresodatos.html\">No
    ingresó el cliente.</a>";
    echo "\t\t<td>\n" . $cliente . "\n</td>\n";
    echo "\t</tr>\n";
    echo "\t<tr>\n";
    echo "\t\t<td>\nProducto\n</td>\n";
        $producto = !empty($product) ? $product : "<a href=\"ingresodatos.html\">No
        ingresó el producto.</a>";
        echo "\t\t<td>\n" . $producto . "\n</td>\n";
        echo "\t</tr>\n";
        echo "\t<tr class=\"odd\">\n";
        echo "\t\t<td>\nPrecio\n</td>\n";
        $precio = !empty($price) ? $price : "<a href=\"ingresodatos.html\">No ingresó
        el precio</a>";
        echo "\t\t<td>\n" . $precio . "\n</td>\n";
        echo "\t</tr>\n";
        echo "\t<tr>\n";
        echo "\t\t<td>\nCantidad\n</td>\n";
    $cantidad = !empty($quantity) ? $quantity : "<a href=\"ingresodatos.html\">No
    ...
    <div id="link">
    <a href="ejercicio3.php" class="button-link">Ingresar nuevos datos</a>
    </div>
</div>
</article>
</section>
